...
window.addEventListener("scroll", function() {
  ...
  if (window.pageYOffset < yConsultorios - 50) {
    ...
    document.getElementById("inicio_link").style.color = "#24415c";
    document.getElementById("consultorios_link").style.color = "#424242";
  } else if (
    ...
    document.getElementById("inicio_link").style.color = "#424242";
    document.getElementById("consultorios_link").style.color = "#24415c";
    document.getElementById("equipe_link").style.color = "#424242";
  } else if (
    window.pageYOffset > yEquipe - 50 &&
    ...
    document.getElementById("consultorios_link").style.color = "#424242";
    document.getElementById("equipe_link").style.color = "#24415c";
    document.getElementById("contato_link").style.color = "#424242";
  } else if (window.pageYOffset > yContato - 50) {
    document.getElementById("people_icon").style.backgroundPositionY = "0";
    document.getElementById("phone_icon").style.backgroundPositionY = "36px";
    document.getElementById("equipe_link").style.color = "#424242";
    document.getElementById("contato_link").style.color = "#24415c";
  }
});
